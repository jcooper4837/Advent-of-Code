...
public class Circuit
{
    ...
    public static void main(String[] args)
    {
        ...
        int codes[] = new int[memory.length], amp[] = new int[5];
        int in = 0, max = 0, a;
        boolean newval = true, halt;
                    ...
                    if (opcode != 99)
                    {
                        ...
                        else if (opcode == 3 || opcode == 4)
                        {
                            ...
                            if (opcode == 3)
                            {
                                if (newval)
                                {
                                    System.out.println("apple - inputting mode");
                                    codes[pos[0]] = amp[a%5];
                                    newval = false;
                                }
                                else
                                {
                                    System.out.println("banana - inputting value");
                                    codes[pos[0]] = in;
                                    newval = true;
                                }
                            }
                            ...
                            {
                                System.out.println("output called, a = " + a);
