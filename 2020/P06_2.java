    ...
    public static void main(String[] args)
    {
        ...
        while (true)
        {
            ...
            while (t.length() > 0 && !t.equals("0"))
            {
                ...
                {
                    if (!t.contains(used.substring(i, i+1)))
                    {
                        used = used.substring(0, used.indexOf(used.charAt(i))) + used.substring(used.indexOf(used.charAt(i))+1);
                        i--;
                    }
                    if (used.length() == 0)
                    {
            ...
            {
                if (used.contains(str.substring(i, i+1)))
                {
                    a[(int) str.charAt(i) - 97]++;
                    used = used.substring(0, used.indexOf(str.charAt(i))) + used.substring(used.indexOf(str.charAt(i))+1);
                }
            }
            if (t.equals("0"))
            {
