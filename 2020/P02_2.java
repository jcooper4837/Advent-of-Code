...
public class P02_2
{
    public static void main(String[] args)
    {
        ...
        while (true)
        {
            ...
            low = Integer.parseInt(line.substring(0, line.indexOf('-'))) - 1;
            high = Integer.parseInt(line.substring(line.indexOf('-')+1, line.indexOf(' '))) - 1;
            ch = line.charAt(line.indexOf(' ')+1);
            line = line.substring(line.indexOf(':')+2);
            count = 0;
            if (ch == line.charAt(low) ^ ch == line.charAt(high))
            {
                total++;
            }
