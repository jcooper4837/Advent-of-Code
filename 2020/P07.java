...
public class P07
{
    public static void main(String[] args)
    {
        ...
        while (true)
        {
            ...
            String cont = t.substring(0, t.indexOf(" bags contain"));
            entries.add(cont);
            t = t.substring(t.indexOf(" bags contain")+14);
            while (t.length() > 1)
            {
                cont = t.substring(0, t.indexOf("bag"));
                ...
                {
                    entries.add(t.substring(t.indexOf(c)+2, t.indexOf(" bag")));
                }
                t = t.substring(t.indexOf("bag")+4);
            }
            list.add(entries);
        }
        ...
        for (int i = 0; i < list.size(); i++)
        {
            if (list.get(i).contains(str) && !list.get(i).get(0).equals(str))
            {
                if (!entries.contains(list.get(i).get(0)))
                {
                    entries.add(list.get(i).get(0));
                }
                //System.out.println(list.get(i));
            }
        }
        ...
        for (int i = 0; i < list.size(); i++)
        {
            ...
            {
                if (list.get(i).contains(entries.get(j)) && !list.get(i).get(0).equals(entries.get(j)))
                {
                    if (!entries.contains(list.get(i).get(0)))
                    {
                        //System.out.println(list.get(i).get(0) + ", contains: " + entries.get(j));
                        entries.add(list.get(i).get(0));
                        i = -1;
                        break;
                    }
