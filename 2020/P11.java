        ...
        while (!done)
        {
            ...
            for (int i = 0; i < ch.length; i++)
            {
                for (int j = 0; j < ch[0].length; j++)
                {
                    if (ch[i][j] == 'L')
                    {
                        if ((!inBound(i, ch.length, 1) || ch[i+1][j] != '#') &&
                                (!inBound(i, ch.length, -1) || ch[i-1][j] != '#') &&
                                (!inBound(j, ch[0].length, 1) || ch[i][j+1] != '#') &&
                                (!inBound(j, ch[0].length, -1) || ch[i][j-1] != '#') &&
                                (!inBound(i, ch.length, 1) || !inBound(j, ch[0].length, 1) || ch[i+1][j+1] != '#') &&
                                (!inBound(i, ch.length, -1) || !inBound(j, ch[0].length, 1) || ch[i-1][j+1] != '#') &&
                                (!inBound(i, ch.length, 1) || !inBound(j, ch[0].length, -1) || ch[i+1][j-1] != '#') &&
                                (!inBound(i, ch.length, -1) || !inBound(j, ch[0].length, -1) || ch[i-1][j-1] != '#'))
                        {
                    ...
                    if (ch[i][j] == '#')
                    {
                        ...
                        if ((inBound(j, ch[0].length, 1) && ch[i][j+1] == '#'))
                        {
                            filled++;
                        }
                        if ((inBound(j, ch[0].length, -1) && ch[i][j-1] == '#'))
                        ...
                        if ((inBound(i, ch.length, 1) && inBound(j, ch[0].length, 1) && ch[i+1][j+1] == '#'))
                        {
                            filled++;
                        }
                        if ((inBound(i, ch.length, -1) && inBound(j, ch[0].length, 1) && ch[i-1][j+1] == '#'))
