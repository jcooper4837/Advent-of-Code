...
public class P04_2
{
    ...
    public static boolean isValid(String[] s)
    {
        ...
        {
            if (s[i].length() < 1 || s[i].substring(0, 3).equals("cid"))
            {
            ...
            else if (s[i].substring(0, 3).equals("byr"))
            {
                t = Integer.parseInt(s[i].substring(4));
                if (t < 1920 || t > 2002)
                {
                    //System.out.print("fail byr -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("iyr"))
            {
                t = Integer.parseInt(s[i].substring(4));
                if (t < 2010 || t > 2020)
                {
                    //System.out.print("fail iyr -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("eyr"))
            {
                t = Integer.parseInt(s[i].substring(4));
                if (t < 2020 || t > 2030)
                {
                    //System.out.print("fail eyr -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("hgt"))
            {
                t = Integer.parseInt(s[i].substring(4, s[i].length() - 2));
                String u = s[i].substring(s[i].length() - 2);
                if ((u.equals("cm") && (t < 150 || t > 193)) || (u.equals("in") && (t < 59 || t > 76)))
                {
                    //System.out.print("fail hgt -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("hcl"))
            {
                if (s[i].charAt(4) != '#')
                {
                    //System.out.print("fail hcl -> ");
                    return false;
                }
                if (!s[i].substring(5).matches("^[a-zA-Z0-9]*$") || s[i].substring(5).length() != 6)
                {
                    //System.out.print("fail hcl -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("ecl"))
            {
                if (!s[i].substring(4).equals("amb") && !s[i].substring(4).equals("blu") && !s[i].substring(4).equals("brn") && !s[i].substring(4).equals("gry") && !s[i].substring(4).equals("grn") && !s[i].substring(4).equals("hzl") && !s[i].substring(4).equals("oth"))
                {
                    //System.out.print("fail ecl -> ");
                    return false;
                }
            }
            else if (s[i].substring(0, 3).equals("pid"))
            {
                if (!s[i].substring(4).matches("[0-9]+") || s[i].substring(4).length() != 9)
                {
                    //System.out.print("fail pid -> ");
                    return false;
                }
            }
            else
